...
with st.expander('About this app'):
    st.markdown('''
        ...
        The library is developed by out in-house staff [Snehan Kekre](https://github.com/snehankekre) who also maintains the [Streamlit Documentation](https://docs.streamlit.io/) website.
        ''')
